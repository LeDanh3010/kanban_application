...
const CardItem = ({ card, cardIndex }) => {
  ...
  return (
    <article
      className="rounded-xl border border-black/5 bg-white p-3.5 shadow-[0_10px_18px_rgba(24,20,18,0.08)] animate-[card-rise_0.4s_ease_both]"
    ...
    >
      ...
      {card.note ? (
        <p className="mt-1 text-xs text-stone-600">{card.note}</p>
      ) : null}
